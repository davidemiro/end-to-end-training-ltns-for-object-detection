...
model_rpn.load_weights('/Users/davidemiro/Desktop/Pesi_allenamenti/model_rpn_new_regression_22_11.hdf5', by_name=True)
model_classifier.load_weights('/Users/davidemiro/Desktop/Pesi_allenamenti/model_classifier_new_regression_22_11.hdf5', by_name=True)
...
for idx, img_data in enumerate(test_imgs):
	...
	#cv2.imshow('img', img)
	#cv2.waitKey(0)
	cv2.imwrite('/Users/davidemiro/Desktop/results/{}.png'.format(img_name),img) 
