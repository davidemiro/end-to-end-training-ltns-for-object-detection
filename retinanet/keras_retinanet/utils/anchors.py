...
def anchor_targets_bbox(
        ...
        annotations_group,
        num_classes,
        negative_overlap=0.3,  # default is 0.4
...
def anchors_for_shape(
    ...
    sizes = [32, 64, 128, 256, 512]  # todo --hard-coded
    # [16, 32, 56, 128, 256]
    # [32, 64, 128, 256, 512] defaults
    # sizes = [24, 48, 96, 192, 384] --proportional
    ...
    for idx, p in enumerate(pyramid_levels):
        anchors = generate_anchors(
            base_size=sizes[idx],  # anchor_params.sizes[idx],
